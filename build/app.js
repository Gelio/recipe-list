...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RecipeList = __webpack_require__(216);

	var _RecipeList2 = _interopRequireDefault(_RecipeList);

	var _RecipePage = __webpack_require__(218);
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(_reactRouter.IndexRoute, { component: _RecipeList2.default }),
	                    _react2.default.createElement(_reactRouter.Route, { path: '/recipe/:recipeID', component: _RecipePage2.default })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _recipeAPI = __webpack_require__(217);

	var _recipeAPI2 = _interopRequireDefault(_recipeAPI);
	...
	var RecipeList = function (_React$Component) {
	    ...
	    _createClass(RecipeList, [{
	        ...
	        value: function addNewRecipe() {
	            var recipeList = _recipeAPI2.default.getRecipesList(),
	            ...
	            _recipeAPI2.default.saveRecipesList(recipeList);
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    null,
	                    'You have ',
	                    _recipeAPI2.default.getRecipesList().length,
	                    ' recipes saved.'
	                ),
	                _react2.default.createElement(
	                    'ul',
	                    null,
	                    _recipeAPI2.default.getRecipesList().map(function (recipe, i) {
	                        return _react2.default.createElement(
	                            'li',
	                            { key: i },
	                            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'button',
	                    { type: 'button', className: 'btn btn-primary', onClick: this.addNewRecipe.bind(this) },
	                    'Add new recipe'
	                )
	            );
	        }
...
/***/ function(module, exports) {
	...
	function getRecipesList() {
	    if (this.currentRecipeList) return this.currentRecipeList;

	    if (!localStorage.getItem('recipes')) this.saveRecipesList(defaultRecipeList);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RecipeError = __webpack_require__(219);

	var _RecipeError2 = _interopRequireDefault(_RecipeError);

	var _RecipeEditForm = __webpack_require__(220);
	    ...
	    _createClass(RecipePage, [{
	        ...
	        value: function componentDidMount() {
	            var recipeID = this.props.params.recipeID,
	                recipe = _recipeAPI2.default.getRecipeByID(recipeID);
	        ...
	        key: 'beginEditingRecipe',
	        value: function beginEditingRecipe() {
	            this.setState({
	                editing: true
	            });
	        }
	        ...
	        value: function deleteRecipe() {
	            _recipeAPI2.default.deleteRecipeByID(this.state.recipeID);
	        ...
	        value: function saveRecipe() {
	            ...
	            parsedRecipe.ingredients = parsedRecipe.ingredients.filter(function (ingredient) {
	            ...
	            _recipeAPI2.default.saveRecipeByID(this.state.recipeID, parsedRecipe);
	            this.setState({
	                editing: false
	            });
	        }
	        ...
	        key: 'acceptChanges',
	        value: function acceptChanges(newRecipe) {
	            this.setState({
	                recipe: newRecipe
	            });
	        }
	        ...
	        key: 'render',
	        value: function render() {
	            if (!this.state.recipe) return _react2.default.createElement(_RecipeError2.default, null);else if (this.state.editing) return _react2.default.createElement(_RecipeEditForm2.default, { recipe: this.state.recipe, acceptChanges: this.acceptChanges.bind(this), saveRecipe: this.saveRecipe.bind(this), discardChanges: this.discardChanges.bind(this) });else return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(
	                    'h2',
	                ...
	                _react2.default.createElement(
	                    'ul',
	                    null,
	                    this.state.recipe.ingredients.map(function (ingredient, i) {
	                        return _react2.default.createElement(
	                            'li',
	                            { key: i },
	                            ingredient
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'button',
	                        { type: 'button', className: 'btn btn-primary m-r-1', onClick: this.beginEditingRecipe.bind(this) },
	                        'Edit'
	                    ),
	                    _react2.default.createElement(
	                        'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecipeError = function (_React$Component) {
	    _inherits(RecipeError, _React$Component);

	    function RecipeError() {
	        _classCallCheck(this, RecipeError);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(RecipeError).apply(this, arguments));
	    }

	    _createClass(RecipeError, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'alert alert-danger' },
	                'There\'s been an error and your recipe can\'t be fetched. Please return to the ',
	                _react2.default.createElement(
	                    _reactRouter.Link,
	                    { to: '/' },
	                    'main page'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IngredientEdit = __webpack_require__(221);
	...
	var RecipeEditForm = function (_React$Component) {
	    _inherits(RecipeEditForm, _React$Component);

	    function RecipeEditForm() {
	        _classCallCheck(this, RecipeEditForm);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(RecipeEditForm).apply(this, arguments));
	    }

	    _createClass(RecipeEditForm, [{
	        key: 'changeRecipeName',
	        value: function changeRecipeName(e) {
	        ...
	        key: 'changeIngredient',
	        value: function changeIngredient(ingredient, i) {
	        ...
	        value: function deleteIngredient(i) {
	            var ingredients = this.props.recipe.ingredients;
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement('input', { type: 'text', value: this.props.recipe.name, onChange: this.changeRecipeName.bind(this) }),
	                _react2.default.createElement(
	                    'p',
	                    null,
	                    'Ingredients:'
	                ...
	                _react2.default.createElement(
	                    ...
	                    this.props.recipe.ingredients.map(function (ingredient, i) {
	                        return _react2.default.createElement(
	                            'li',
	                            { key: i },
	                            _react2.default.createElement(_IngredientEdit2.default, { changeIngredient: _this2.changeIngredient.bind(_this2), deleteIngredient: _this2.deleteIngredient.bind(_this2, i), ingredient: ingredient, index: i })
	                        );
	                    })
	                ),
	                _react2.default.createElement(
	                    'button',
	                    { type: 'button', className: 'btn btn-secondary', onClick: this.addNewIngredient.bind(this) },
	                    'Add new ingredient'
	                ),
	                _react2.default.createElement(
	                    'div',
	                    ...
	                    _react2.default.createElement(
	                        'button',
	                        { type: 'button', className: 'btn btn-success m-r-1', onClick: this.props.saveRecipe },
	                        'Save'
	                    ),
	                    _react2.default.createElement(
	                        'button',
	                        { type: 'button', className: 'btn btn-warning', onClick: this.props.discardChanges },
	                        'Discard changes'
	                    )
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IngredientEdit = function (_React$Component) {
	    _inherits(IngredientEdit, _React$Component);

	    function IngredientEdit() {
	        _classCallCheck(this, IngredientEdit);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(IngredientEdit).apply(this, arguments));
	    }

	    _createClass(IngredientEdit, [{
	        key: "changeIngredient",
	        value: function changeIngredient(e) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "span",
	                null,
	                _react2.default.createElement("input", { type: "text", value: this.props.ingredient, onChange: this.changeIngredient.bind(this) }),
	                " ",
	                _react2.default.createElement(
	                    "button",
	                    { className: "btn", onClick: this.props.deleteIngredient },
	                    "-"
	                )
	            );
	        }
	...
	exports.default = IngredientEdit;
